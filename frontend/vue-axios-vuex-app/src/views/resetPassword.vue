<template>
    ...
    <div class="cont_logo"></div>
      ...
      <form @submit.prevent="handleSubmit" class="form">
        <div class="input-group">
          <input type="text" id="verCode" v-model="verCode" required class="inputLogin" placeholder="Verification Code"/>
        </div>
        <div class="input-group">
          <input type="password" id="password" v-model="password" required class="inputLogin" placeholder="Enter your password"/>
        </div>
        <div class="input-group">
          <input type="password" id="passwordConfirm" v-model="passwordConfirm" required class="inputLogin" placeholder="Confirm your password"/>
        </div>
  ...
  const handleSubmit = () => {
    ...
    if(password.value !== passwordConfirm.value){
        text.value = "Both passwords have to be the same.";
        type.value = "error";
    ...
    swapResource
      .verifyAndChanegPassword({ verCode: verCode.value, password: password.value }) // Adjust API parameters as needed
      .then((response) => {
        if (response.success) {
            console.log(response);
            text.value = "Password Succesfully Changed.";
            type.value = "success";
            showSuccessErrorCard.value = true;
            setTimeout(() => {
                showSuccessErrorCard.value = false;
